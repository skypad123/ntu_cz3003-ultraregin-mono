...
const ChooseUpdateQuestionsStudent = () => {
    ...
    const handleQuestionUpdate = (questionID) => {
        ...
        navigate({
            pathname: '/update-questions-student/qn',
        ...
        <section>
          <div class="container">
              ...
              <div class="question-details-container">
                    {
                        (questionData.length > 0) ? questionData.filter(question => question.attributes.name.split(",")[0] === "4").map(question => {
...
export default ChooseUpdateQuestionsStudent;