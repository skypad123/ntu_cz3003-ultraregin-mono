    ...
    const handleSubmit = async e => {
        ...
        try {
            ...
            if (response.status === 200){
                ...
                navigate({
                    pathname: '/choose-update-questions'
                })
            }
        }  
        catch (e) {
                                ...
                                switch (world) {
                                    case "1": return (
                                        <div class="input-group-btn">
                                            <input type="radio" id="world1" name="world" value="1" checked onChange = {e => setWorld(e.target.value)} />
                                    ...
                                    case "2": return (
                                        <div class="input-group-btn">
                                            ...
                                            <label for="world1">1</label>
                                            <input type="radio" id="world2" name="world" value="2" checked onChange = {e => setWorld(e.target.value)} />
                                            <label for="world2">2</label>
                                            <input type="radio" id="world3" name="world" value="3" onChange = {e => setWorld(e.target.value)} />
                                            <label for="world3">3</label>
                                            <input type="radio" id="worldCustom" name="world" value="4" onChange = {e => setWorld(e.target.value)} />
                                    ...
                                    case "3": return (
                                        <div class="input-group-btn">
                                            ...
                                            <input type="radio" id="world2" name="world" value="2" onChange = {e => setWorld(e.target.value)} />
                                            <label for="world2">2</label>
                                            <input type="radio" id="world3" name="world" value="3" checked onChange = {e => setWorld(e.target.value)} />
                                            <label for="world3">3</label>
                                            <input type="radio" id="worldCustom" name="world" value="4" onChange = {e => setWorld(e.target.value)} />
                                            <label for="worldCustom">Custom</label>
                                        </div>
